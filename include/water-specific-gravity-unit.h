...
Declare_Physical_Quantity(WaterSpecificGravity, "Sgw",
...
Declare_Unit(pwl_lb_ft3, "pwl_lb/ft3",
	     ...
	     denoted as pound per cubic feet)DESC", WaterSpecificGravity, 62.366389027, 78);


Declare_Unit(Sgw_Percent, "sgwPercent",
	     R"DESC(Unit used to measure salinity of a brine
	      in normal conditions in percentage of disolved solid)DESC", WaterSpecificGravity, 1, 1.2506);
...
Declare_Unit(Sgw_sg, "swsg",
	     ...
	     density of a pure water;)DESC", WaterSpecificGravity, 1, 1.2506);

Declare_Unit(Sgw_PPM, "swppm",
	     R"DESC(Total solid disolved in a brine
	      measure in Part Per Million PPM)DESC", WaterSpecificGravity, 0, 317642.11170139315);
