...
add_title("DE GHETTO, PAONE & VILLA CORRELATION FOR EXTRA-HEAVY (MODIFIED STANDING CORRELATION) AND HEAVY (MODIFIED VASQUEZ & BEGGS CORRELATION) OILS, CALCULATION OF SOLUTION GOR")
...
add_parameter("pb", "psia", "Bubble point pressure", "Quantity<psig>(150)", "Quantity<psig>(7127)")
add_parameter("p", "psia", "Pressure")
...
begin_correlation("RsHanafy", "SolutionGasOilRelation", "SCF_STB", 97, 4272)
add_title("HANAFY ET AL. CORRELATION, CALCULATION OF SOLUTION GOR")
...
add_parameter("pb", "psia", "Bubble point pressure", 130, 7000)
add_parameter("p", "psia", "Pressure")
...
add_title("TOTAL COMPAGNIE FRANÇAISE DES PÉTROLES (CFP) CORRELATION, CALCULATION OF SOLUTION GOR")
...
add_title("VAZQUEZ & BEGGS CORRELATION, CALCULATION OF SOLUTION GOR")
...
add_title("VELARDE, BLASINGAME & McCAIN CORRELATION, CALCULATION OF SOLUTION GO")
...
add_title("PÉREZ, HENY & LAGO CORRELATION (MODIFIED MILLÁN-ARCIA CORRELATION), CALCULATION OF SOLUTION GOR")
add_parameter("yg", "Sgg", "Gas specific gravity")
...
add_title("MILLÁN-ARCIA CORRELATION, CALCULATION OF SOLUTION GOR")
