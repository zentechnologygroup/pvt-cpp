...
add_parameter("t", "Rankine", "Temperature",  "Quantity<Fahrenheit>(100)",  "Quantity<Fahrenheit>(258)") 
...
add_parameter("co", "psia_1", "Coefficient of isothermal compressibility ",  1.032e-6,  4.35e-6)
add_author("Hanafy")
end_correlation()
