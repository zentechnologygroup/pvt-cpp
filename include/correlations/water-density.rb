...
add_parameter("pr", "mPascal", "Pressure",  0.9,  200)
add_parameter("s", "Disolved_Salt_Percent", "Dissolved salt concentration", 0, 26) 
...
add_parameter("t", "Celsius", "Temperature",  0,  275) 
add_parameter("pr", "mPascal", "Pressure",  0.1,  200)
add_parameter("s", "Disolved_Salt_Percent", "Dissolved salt concentration", 0, 26)
