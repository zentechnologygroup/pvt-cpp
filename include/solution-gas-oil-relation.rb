...
add_parameter("p", "psia", "Aqui Neylith",  20,  3573)
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(44.6)",  "Quantity<Api>(19.4)")
add_parameter("t", "Rankine", "Aqui Neylith",  "Quantity<Fahrenheit>(74)",  "Quantity<Fahrenheit>(240)") 
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  26,  1602)
...
add_parameter("pb", "psia", "Aqui Neylith",  208.6,  4021.96)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.798,  1.29)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.65,  1.276)
add_parameter("pb", "psia", "Aqui Neylith",  150,  7127)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("api", "Api", "Aqui Neylith",  22.3,  48.1)
add_parameter("t", "Fahrenheit", "Aqui Neylith",  80,  280)
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  90,  2637)
...
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  97,  4272)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.28,  1.668)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.574,  1.223)
add_parameter("pb", "psia", "Aqui Neylith",  48,  5780)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(51.1)",  "Quantity<Api>(17.9)")
add_parameter("t", "Rankine", "Aqui Neylith",  "Quantity<Fahrenheit>(82)",  "Quantity<Fahrenheit>(272)") 
...
add_parameter("pb", "psia", "Aqui Neylith",  130,  700)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("api", "Api", "Aqui Neylith",  16.5,  63.8)
add_parameter("t", "Fahrenheit", "Aqui Neylith",  100,  258)
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  20,  1425)
...
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("api", "Api", "Aqui Neylith",  0,  45)
...
add_parameter("pb", "psia", "Aqui Neylith",  15,  6055)
add_parameter("p",  "psia", "Aqui Neylith")
...
add_parameter("psep", "psia", "Aqui Neylith",  60,  595) 
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  0,  2199)
...
add_parameter("pb", "psig", "Aqui Neylith",  "Quantity<psia>(106)",  "Quantity<psia>(5312)")
add_parameter("p",  "psig", "Aqui Neylith")
add_parameter("api", "Api", "Aqui Neylith",  11.6,  53.4)
...
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("api", "Api", "Aqui Neylith",  22,  41.9)
add_parameter("t", "Fahrenheit", "Aqui Neylith",  117,  354)
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  135,  4290)
add_author("Cegarra")
end_correlation()
...
add_parameter("yg",  "Sgg", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  222,  3432.7)
add_parameter("p",  "psia", "Aqui Neylith")
...
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  180,  2500)
