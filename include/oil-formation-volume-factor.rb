...
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(44.6)",  "Quantity<Api>(19.4)")
add_parameter("rs", "SCF_STB", "Aqui Neylith",  26,  1602)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("t", "Rankine", "Aqui Neylith",  "Quantity<Fahrenheit>(100)",  "Quantity<Fahrenheit>(258)") 
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  130,  3573)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.51,  3.44)
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(63.7)",  "Quantity<Api>(6)")
add_parameter("rs", "SCF_STB", "Aqui Neylith",  6,  3298.6)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("t", "Fahrenheit", "Aqui Neylith",  74,  341.6)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  31.7,  7127)
add_parameter("co",  "psia_1", "Aqui Neylith")
...
add_parameter("co", "psia_1", "Aqui Neylith",  1.057,  1.362)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.6017,  1.027)
add_parameter("api", "Api", "Aqui Neylith",  14.7,  40)
add_parameter("rs",  "SCF_STB", "Aqui Neylith")
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  133,  3050)
add_parameter("t", "Fahrenheit", "Aqui Neylith",  117,  276)
add_parameter("tsep",  "Fahrenheit", "Aqui Neylith")
add_parameter("p",  "psia", "Aqui Neylith")
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.789,  1.29)
add_parameter("yo", "Sg_do", "Aqui Neylith",  0.8236,  0.886)
add_parameter("rs",  "SCF_STB", "Aqui Neylith")
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  181,  2266)
add_parameter("t", "Rankine", "Aqui Neylith",  "Quantity<Fahrenheit>(190)",  "Quantity<Fahrenheit>(275)") 
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  590,  4640)
add_parameter("co",  "psia_1", "Aqui Neylith")
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.650,  1.276)
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(48.1)",  "Quantity<Api>(22.3)")
add_parameter("rs", "SCF_STB", "Aqui Neylith",  90,  2637)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("t", "Fahrenheit", "Aqui Neylith",  80,  280)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  150,  7127)
add_parameter("co",  "psia_1", "Aqui Neylith")
add_author("Glaso")
end_correlation()
...
add_parameter("rs", "SCF_STB", "Aqui Neylith",  7,  4272)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  36,  5003)
add_parameter("co", "psia_1", "Aqui Neylith",  1.032e-6,  4.35e-6)
add_author("Hanafy")
end_correlation()
...
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(59)",  "Quantity<Api>(14.4)")
...
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  14.7,  6054.7)
...
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(51.1)",  "Quantity<Api>(17.9)")
add_parameter("rs",  "SCF_STB", "Aqui Neylith")
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  3,  2905)
add_parameter("t", "Fahrenheit", "Aqui Neylith",  82,  272)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  48,  5780)
add_parameter("co",  "psia_1", "Aqui Neylith")
add_author("Lasater")
end_correlation()
...
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(45)",  "Quantity<Api>(16.3)")
add_parameter("rs", "SCF_STB", "Aqui Neylith",  217,  1406)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.59,  0.95)
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(63.8)",  "Quantity<Api>(16.5)")
add_parameter("rs", "SCF_STB", "Aqui Neylith",  20,  1425)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("t", "Fahrenheit", "Aqui Neylith",  100,  258)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb",  "psia", "Aqui Neylith")
add_parameter("co",  "psia_1", "Aqui Neylith")
add_author("Standing")
...
add_ref("banzer:1996")             
add_parameter("yg",  "Sgg", "Aqui Neylith")
add_parameter("api",  "Api", "Aqui Neylith")
add_parameter("rs",  "SCF_STB", "Aqui Neylith")
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
...
add_ref("banzer:1996")
add_parameter("yg", "Sgg", "Aqui Neylith",  0.511,  1.35)
add_parameter("api", "Api", "Aqui Neylith",  15.3,  59.3)
add_parameter("rs", "SCF_STB", "Aqui Neylith",  0,  2199)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("t", "Fahrenheit", "Aqui Neylith",  75,  294)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.654,  1.337)
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(41.8)",  "Quantity<Api>(22)")
add_parameter("rs", "SCF_STB", "Aqui Neylith",  135,  4290)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("t", "Fahrenheit", "Aqui Neylith",  117,  354)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  735,  7303)
add_parameter("co",  "psia_1", "Aqui Neylith")
add_author("Cegarra")
end_correlation()
...
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(12.9)",  "Quantity<Api>(6.4)")
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.561,  1.101)
add_parameter("yo", "Sg_do", "Aqui Neylith",  "Quantity<Api>(53.4)",  "Quantity<Api>(11.6)")
add_parameter("rs",  "SCF_STB", "Aqui Neylith")
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  102,  1808)
add_parameter("t", "Fahrenheit", "Aqui Neylith",  70,  307)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  106,  5312)
add_parameter("co",  "psia_1", "Aqui Neylith")
...
add_parameter("yg",  "Sgg", "Aqui Neylith")
add_parameter("api", "Api", "Aqui Neylith",  9,  20.2)
add_parameter("rs", "SCF_STB", "Aqui Neylith",  53,  459)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
...
add_parameter("yg",  "Sgg", "Aqui Neylith")
add_parameter("api", "Api", "Aqui Neylith",  14,  40)
add_parameter("rs", "SCF_STB", "Aqui Neylith",  180,  2500)
add_parameter("rsb",  "SCF_STB", "Aqui Neylith")
add_parameter("t", "Fahrenheit", "Aqui Neylith",  165,  304)
add_parameter("p",  "psia", "Aqui Neylith")
add_parameter("pb", "psia", "Aqui Neylith",  1230,  5035)
add_parameter("co",  "psia_1", "Aqui Neylith")
