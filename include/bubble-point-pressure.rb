...
add_parameter("yo", "Sg_do", "Aqui Neylith",  0.803521,  0.937707)
...
add_parameter("yo", "Sg_do", "Aqui Neylith",  0.724898,  1.02909)
...
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  36,  5003)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.5,  1.668)
...
add_parameter("api", "Api", "Aqui Neylith",  17.9,  51.1)
...
add_parameter("api", "Api", "Aqui Neylith",  "Api::get_instance().min_val",  45)
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.56,  1.18)
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  20,  2070)
...
add_parameter("psep",  "psia", "Aqui Neylith")
...
add_parameter("yg", "Sgg", "Aqui Neylith",  0.556,  1.367)
add_parameter("rsb", "SCF_STB", "Aqui Neylith",  10,  1870)
add_parameter("api", "Api", "Aqui Neylith",  12,  55)
add_parameter("t", "Fahrenheit", "Aqui Neylith",  74,  327)
...
add_parameter("n2_concentration", "MolePercent", "Aqui Neylith",  0,  26)
add_parameter("co2_concentration","MolePercent", "Aqui Neylith",  0,  26)
add_parameter("h2s_concentration", "MolePercent", "Aqui Neylith",  0,  50)
