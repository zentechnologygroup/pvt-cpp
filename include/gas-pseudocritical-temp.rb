...
add_note("Brown et al.'s reference is not available. The correlation was verified by using these references: Standing (1977), Ahmed (1989), and Bánzer (1996). Date: September 14 2016.")
add_ref('standing:1977')
add_ref('brown:1948')
add_ref('ahmed:1989')
add_ref('banzer:1996')
add_parameter('yghc', 'Sgg', "Aqui Neylith",  0.55,  1.67)
add_parameter('n2_concentration', 'MoleFraction', "Aqui Neylith",  "Quantity<MolePercent>(0)",  "Quantity<MolePercent>(5)") 
...
add_ref('ahmed:1989')
add_ref('banzer:1996')
add_parameter('yghc', 'Sgg', "Aqui Neylith",  0.58,  1.3)
add_parameter('n2_concentration', 'MoleFraction', "Aqui Neylith",  "Quantity<MolePercent>(0)",  "Quantity<MolePercent>(5)") 
add_parameter('co2_concentration', 'MoleFraction', "Aqui Neylith",  "Quantity<MolePercent>(0)",  "Quantity<MolePercent>(2)") 
add_parameter('h2s_concentration', 'MoleFraction', "Aqui Neylith",  "Quantity<MolePercent>(0)",  "Quantity<MolePercent>(2)") 
...
add_ref('sutton:1985')
add_parameter('yghc', 'Sgg', "Aqui Neylith",  0.571,  1.679)
add_parameter('n2_concentration', 'MoleFraction', "Aqui Neylith",  "Quantity<MolePercent>(0)",  "Quantity<MolePercent>(2.86)") 
add_parameter('co2_concentration', 'MoleFraction', "Aqui Neylith",  "Quantity<MolePercent>(0.01)",  "Quantity<MolePercent>(11.86)") 
add_parameter('h2s_concentration', 'MoleFraction', "Aqui Neylith",  "Quantity<MolePercent>(0)",  "Quantity<MolePercent>(0)") 
add_author("Sutton")
end_correlation()
...
add_parameter("yghc", "Sgg", "Aqui Neylith",  0.61,  1.89)
