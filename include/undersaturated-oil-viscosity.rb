...
add_parameter("uob", "CP", "Aqui Neylith",  0.168,  184.86)
add_parameter("pb", "psia", "Aqui Neylith",  24.7,  4764.7)
add_parameter("p", "psia", "Aqui Neylith",  24.7,  6014.7)
...
add_parameter("uob", "CP", "Aqui Neylith",  2.1,  295.9)
add_parameter("p", "psia", "Aqui Neylith",  1038.49,  7411.54)
add_parameter("pb", "psia", "Aqui Neylith",  1038.49,  7411.54)
...
add_parameter("uob", "CP", "Aqui Neylith",  0.142,  127)
add_parameter("p", "psia", "Aqui Neylith",  1500,  5500)
add_parameter("pb", "psia", "Aqui Neylith",  125,  4120)
add_author("Beal")
end_correlation()
...
add_parameter("uob", "CP", "Aqui Neylith",  0.117,  148)
...
add_parameter("uob", "CP", "Aqui Neylith",  0.13,  17.9)
add_parameter("p", "psia", "Aqui Neylith",  4.7,  5015)
add_parameter("pb", "psia", "Aqui Neylith",  4.7,  5015)
...
add_parameter("uob", "CP", "Aqui Neylith",  0.211,  3.546)
add_parameter("p", "psia", "Aqui Neylith",  1600,  10250)
add_parameter("pb", "psia", "Aqui Neylith",  1574,  9552)
...
add_parameter("uob",  "CP", "Aqui Neylith")
add_parameter("p", "psia", "Aqui Neylith",  )
add_parameter("pb", "psia", "Aqui Neylith",  1340,  4513)
add_author("Abedini")
end_correlation()
...
add_parameter("uob", "CP", "Aqui Neylith",  0.161,  8.7)
add_parameter("p", "psia", "Aqui Neylith",  202,  10140)
