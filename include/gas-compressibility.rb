...
add_parameter("tpr", "PseudoReducedTemperature", 1.05, 2.95)
add_parameter("ppr", "PseudoReducedPressure", 0.1, 14.9)
add_ref("sarem:1961")
...
add_parameter("tpr", "PseudoReducedTemperature", 1.2, 3)
add_parameter("ppr", "PseudoReducedPressure", 0.1, 24)
add_ref("hall:1973")
...
add_parameter("tpr", "PseudoReducedTemperature", 1.05, 3)
add_parameter("ppr", "PseudoReducedPressure", 0.2, 30)
...
add_parameter("tpr", "PseudoReducedTemperature", 1, 3)
add_parameter("ppr", "PseudoReducedPressure", 0.2, 30)
...
add_parameter("tpr", "PseudoReducedTemperature", 1.05, 3)
add_parameter("ppr", "PseudoReducedPressure", 0.2, 15)
add_ref("gopal:1977")
add_ref("standing:1942")
add_ref("banzer:1996")
add_ref("takacs:1989")
...
add_parameter("tpr", "PseudoReducedTemperature", 1.2, 2.4)
add_parameter("ppr", "PseudoReducedPressure", 0, 13)
add_ref("brill:1974")
add_ref("standing:1942")
add_ref("banzer:1996")
