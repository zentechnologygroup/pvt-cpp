...
add_ref("banzer:1996")
add_db("Based on the equation of state of Starling-Carnahan for the calculation of Z-factor.")
...
add_ref("banzer:1996")
add_ref("takacs:1989")
add_db("Gopal presented a non-iterative method for calculating the Z-factor. The coefficients of the equations where obtained by fitting the Standing-Katz curves.")
add_internal_note("The original reference is not available. The correlation was verified by using a secondary reference: Bánzer (1996). Date: September 23 2016.")
add_internal_note("The application ranges and data bank information was obtained from Takacs (1989).")
end_correlation()
